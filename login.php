		...
		<div class="background__wrapper--login">
			<div class="login">
				...
				<form action="logic/login_form.php" method="POST">
					<label for="text">Username</label><input class="input__login" id ="text" type="text" name="username" placeholder="username">
					<label for="password">Password</label><input class="input__login" id="password" type="password" name="password" placeholder="password">
